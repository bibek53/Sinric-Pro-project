...
#define APP_KEY "Your_API_Key"            // Should look like "de0bxxxx-1x3x-4x3x-ax2x-5dabxxxxxxxx"
#define APP_SECRET "Your_APP_SECRET_Key"  // Should look like "5f36xxxx-x3x7-4x3x-xexe-e86724a9xxxx-4c4axxxx3x3x-x5xe-x9x3-333d65xxxxxx"
#define LIGHT_ID "XXXXXXXXXXXXXXXXXXXXXX"
#define LIGHT_ID_1 "XXXXXXXXXXXXXXXXXXXXXXXXX"
...
void dimTimerISR() {
  if (fade == 1) {
    ...
    if (state == 1) {
      ...
      Dept.of CSE, SaIT 2021 - 2022 Page 42 curBrightness = 0;
    }
  }
